...
**Current Status**: Sumpter v0.3.x is in **alpha**. We provide security patches for the latest v0.3.x release. There is no commitment to backport fixes to earlier patches once a newer minor ships. For an overview of what alpha means across the whole project, see the **Project status: alpha** section of the [README](README.md); this document is the canonical home for supported versions and reporting.
