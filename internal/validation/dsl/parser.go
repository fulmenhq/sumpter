...
// ParseFilter parses the simple filter grammar documented in docs/dsl-reference.md.
func ParseFilter(filterStr string) (*FilterExpression, error) {
	...
	// Operator order is part of the simple-filter compatibility contract.
	operators := []string{"==", "!=", ">=", "<=", ">", "<"}
...
// ParseExpression parses the full Sumpter DSL expression grammar.
func ParseExpression(exprStr string) (*Expression, error) {
	...
	// Ternary has the lowest precedence and is right-associative.
	...
	// Unquoted identifiers are variables, not string constants, in full expressions.
