...
**Context:** Alpha phase - validating NAXML CPJR extraction recipes
...
Example use case from NAXML CPJR:
...
- [NAXML CPJR Extract Recipe](.scratchpad/extract/naxml-cpjr-extract.yaml)
