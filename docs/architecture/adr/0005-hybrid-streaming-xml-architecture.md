...
3. **Retail**: NAXML transaction journals (50-200MB, 10K-100K transactions)
...
- ✅ **Works for all record-based XML** (XBRL, NAXML, clinical, genomics)
...
- **Similar Datasets**:
  ...
  - NAXML transaction journals (50-200MB retail data)
